...
TEST_FUNC constexpr bool test()
{
...

  {
    ...
    static_assert(cuda::std::is_same_v<decltype(common.base()), CopyableView>);
    static_assert(cuda::std::is_same_v<decltype(cuda::std::move(common).base()), CopyableView>);
...

  {
    ...
    static_assert(cuda::std::is_same_v<decltype(cuda::std::move(common).base()), MoveOnlyView>);
    static_assert(!hasLValueQualifiedBase(common));
  }
