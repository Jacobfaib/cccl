...
struct __zv_functors
{
  ...
  struct __zip_op_star
  {
    struct __op_star
    {
      ...
      [[nodiscard]] _CCCL_API constexpr decltype(auto) operator()(_Iter& __i) const noexcept(noexcept(*__i))
      {
        return *__i;
      }
    };
  ...
  template <class _Tuple>
  [[nodiscard]] _CCCL_API static constexpr auto __iter_op_star(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_op_index
  {
    ...
    struct __op_index
    {
      ...
      template <class _Iter>
      [[nodiscard]] _CCCL_API constexpr decltype(auto) operator()(_Iter& __i) const
  ...
  template <class _Diff, class _Tuple>
  [[nodiscard]] _CCCL_API static constexpr auto __iter_op_index(_Diff __n, _Tuple&& __tuple) noexcept(
  ...
  template <class _Tuple>
  [[nodiscard]] _CCCL_API static constexpr auto __iter_move(_Tuple&& __tuple) noexcept(
  ...
  __iter_swap(_Tuple1&& __tuple1, _Tuple2&& __tuple2, index_sequence<_Indices...>) noexcept(noexcept(
    (::cuda::std::ranges::iter_swap(::cuda::std::get<_Indices>(::cuda::std::declval<_Tuple1>()),
                                    ::cuda::std::get<_Indices>(::cuda::std::declval<_Tuple2>())),
     ...)))
  {
...
template <bool _Const, class... _Views>
[[nodiscard]] _CCCL_API constexpr auto __get_zip_view_iterator_tag()
{
...
using __zv_iter_category_base =
  conditional_t<__zip_all_forward<_Const, _Views...>, __zv_iter_category_base_tag, __zv_iter_category_base_none>;
...
public:
  ...
  [[nodiscard]] friend _CCCL_API constexpr auto operator==(const __zip_iterator& __x, const __zip_iterator& __y)
  ...
  template <bool _OtherConst = _Const>
  [[nodiscard]] friend _CCCL_API constexpr auto operator+(const __zip_iterator& __i, difference_type __n)
  ...
  template <bool _OtherConst = _Const>
  [[nodiscard]] friend _CCCL_API constexpr auto operator+(difference_type __n, const __zip_iterator& __i)
    _CCCL_TRAILING_REQUIRES(__zip_iterator)(__zip_all_random_access<_OtherConst, _Views...>)
  {
    return __i + __n;
  }
...
public:
  ...
  template <bool _OtherConst>
  [[nodiscard]] friend _CCCL_API constexpr auto operator==(const __iterator<_OtherConst>& __x, const __zip_sentinel& __y)
...
#if _CCCL_STD_VER <= 2017
  template <bool _OtherConst>
  [[nodiscard]] friend _CCCL_API constexpr auto operator==(const __zip_sentinel& __x, const __iterator<_OtherConst>& __y)
    _CCCL_TRAILING_REQUIRES(bool)(__all_sentinel<_OtherConst>)
  {
