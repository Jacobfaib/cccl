...
public:
  ...
  _CCCL_API constexpr auto begin()
  {
    ...
    {
      return ::cuda::std::common_iterator<iterator_t<_View>, sentinel_t<_View>>{::cuda::std::ranges::begin(__base_)};
    }
    _CCCL_UNREACHABLE();
  }
  ...
  _CCCL_API constexpr auto begin() const
  {
    ...
    {
      return ::cuda::std::common_iterator<iterator_t<const _View>, sentinel_t<const _View>>{
        ::cuda::std::ranges::begin(__base_)};
    }
    _CCCL_UNREACHABLE();
  }
  ...
  _CCCL_API constexpr auto end()
  {
    ...
    {
      return ::cuda::std::common_iterator<iterator_t<_View>, sentinel_t<_View>>{::cuda::std::ranges::end(__base_)};
    }
    _CCCL_UNREACHABLE();
  }
